...
const SplashCursor = dynamic(() =>
  import("@/components/animation/SplashCursor/SplashCursor")
);
        ...
        <div className="relative w-full max-w-7xl flex flex-col md:flex-row items-center justify-between z-10 space-y-10 md:space-y-0 md:space-x-12">
          ...
          >
            ...
            <p className="text-lg leading-relaxed text-white drop-shadow-md">
              ...
              Our team consists of dedicated professionals striving for
              excellence.
            </p>
            <p className="text-lg leading-relaxed text-white drop-shadow-md">
              With years of experience and a deep understanding of the industry,
              we bring efficiency, reliability, and innovation to every project
              we undertake.
            </p>
            <p className="text-lg leading-relaxed text-white drop-shadow-md">
              Our mission is to continuously improve and deliver quality
